import { Schema, model } from "mongoose"; // Importe mongoose pour définir le modèle
...
export default Candidature; // Exporte le modèle pour pouvoir l'utiliser dans d'autres fichiers